...
# createVocabulary(final_train_data)
...
#
final_train_data = '../../training/train_data_word2vec.json'
with open(final_train_data) as f:
  lines = f.read().splitlines()
for line in lines[:20]:
  print(line)
text_ds = tf.data.TextLineDataset(final_train_data).filter(lambda x: tf.cast(tf.strings.length(x), bool))
#
#
